...
export default async function DemoScheduleDetail({params}:{params:Promise<{id:string}>}) {
  ...
  return <main className="container">
    ...
    <div className="card"><table className="table"><thead><tr><th>Date</th><th>Document Ref.</th><th>Revision</th><th>Planned Duration</th><th>Actual Duration</th><th>User</th><th>Status</th><th>Exception</th></tr></thead><tbody>
