...
export default async function WorkspacePage(){
 ...
 const[workAreas,tasks,schedules]=await Promise.all([listWorkAreas(context),listTasks(context),listSchedules(context)]);
 return <main className="workspacePage">
  ...
  <section className="workspaceGrid">
   ...
   <article className="metricCard"><span>Schedules</span><strong>{schedules.length}</strong><p>Local-time plans for future Occurrence generation.</p></article>
  </section>
